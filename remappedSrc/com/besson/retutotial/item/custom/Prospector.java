...
public class Prospector extends Item {
    ...
    public Prospector(net.minecraft.item.Item.Settings settings) {
        super(settings);
    }
...
//    }
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        RegistryEntry<Enchantment> enchantment =
                registryManager.getOrThrow(RegistryKeys.ENCHANTMENT).getEntry(Identifier.ofVanilla("sharpness")).get();
