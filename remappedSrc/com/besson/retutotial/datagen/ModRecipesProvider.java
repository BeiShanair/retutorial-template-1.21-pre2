...
//                600, ModItems.RAW_ICE_ETHER, ModItems.ICE_ETHER, 0.35f);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, Items.SUGAR, 3)
                ...
                .criterion("has_item", RecipeGenerator.conditionsFromItem(Items.BEETROOT))
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, ModBlocks.ICE_ETHER_ORE)
                ...
                .input(Blocks.STONE)
                .criterion("has_item", RecipeGenerator.conditionsFromItem(ModItems.ICE_ETHER))
                .criterion("has_item", RecipeGenerator.conditionsFromItem(Blocks.STONE))
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.ANTHRACITE, 1)
                ...
                .criterion("has_item", RecipeGenerator.conditionsFromItem(Items.COAL))
    ...
    public static void offerCampfireCooking(RecipeExporter exporter, List<ItemConvertible> inputs, RecipeCategory category, ItemConvertible output, float experience, int cookingTime, String group) {
        RecipeGenerator.offerMultipleOptions(exporter, RecipeSerializer.CAMPFIRE_COOKING, CampfireCookingRecipe::new,
